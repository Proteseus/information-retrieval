...
def get_pages():
    for i in tqdm(range(0, 4), desc='Fetching blog details'):
        if i == 0:
            url = 'https://amharic-zehabesha.com/%E1%88%AD%E1%8B%95%E1%88%B5/%e1%8a%a8%e1%89%b3%e1%88%aa%e1%8a%ad-%e1%88%9b%e1%88%85%e1%8b%b0%e1%88%ad'
        else:
            url = f'https://amharic-zehabesha.com/%E1%88%AD%E1%8B%95%E1%88%B5/%e1%8a%a8%e1%89%b3%e1%88%aa%e1%8a%ad-%e1%88%9b%e1%88%85%e1%8b%b0%e1%88%ad/page/{i}'
    ...
    with open('ketarikmahder_stories.json', 'w') as file:
...
async def get_stories():
    urls = []
    blog = []
    with open('ketarikmahder_stories.json', 'r') as file_:
...
async def write_to_excel():
    ...
    df.to_excel('ketarikmahderPressRelease.xlsx', sheet_name='news', index=False)
